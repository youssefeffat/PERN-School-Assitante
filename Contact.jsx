          ...
          <div className="row mb-5">
            <div className="col-12">
              ...
              <h1 className="display-6 text-center mb-4">
                <b>Avez vous des questions ou demandes ? Nous vous écoutons</b>
              </h1>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <form onSubmit={handleSubmit} method="POST">
                ...
                <button type="submit" className="btn btn-outline-primary rounded-pill px-4">Envoyer <i className="fa fa-paper-plane ms-2"></i></button>
              </form>
            </div>
          </div>
        </div>
